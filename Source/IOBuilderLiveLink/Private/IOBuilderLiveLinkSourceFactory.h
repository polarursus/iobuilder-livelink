...
#include "IOBuilderLiveLinkSourceFactory.generated.h"

class SIOBuilderLiveLinkSourceEditor;

UCLASS()
class UIOBuilderLiveLinkSourceFactory : public ULiveLinkSourceFactory
{
public:
